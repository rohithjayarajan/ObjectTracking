...
def videoManipulation(videoPath, writePath):
    ...
    while(vid.isOpened()):
        ...
        if ret == True:
            ...
            ret, trackingWindow = cv2.meanShift(
            ...
            cv2.putText(finalOP7, "Mean Shift Tracking", (125, 125),
                        font, 0.8, (255, 0, 0), 2, cv2.LINE_AA)
            # finalOP7 = HLScartImg
            # cv2.putText(finalOP7, "Cart HSV space", (125, 125), font, 0.8, (255,0,0), 2, cv2.LINE_AA)
            # finalOP8 = HLSmask
            # cv2.putText(finalOP8, "Cart HSV mask", (125, 125), font, 0.8, (255,0,0), 2, cv2.LINE_AA)

            # if frameNumber < 60:
            #     out.write(finalOP1)

            # elif frameNumber >= 60 and frameNumber <60*2:
            #     out.write(finalOP2)

            # elif frameNumber >= 60*2 and frameNumber <60*3:
            #     out.write(finalOP3)

            # elif frameNumber >= 60*3 and frameNumber <60*4:
            #     out.write(finalOP4)

            # elif frameNumber >= 60*4 and frameNumber <60*5:
            #     out.write(finalOP5)

            # elif frameNumber >= 60*5 and frameNumber <60*6:
            #     out.write(finalOP6)

            # elif frameNumber >= 60*6:
            #     out.write(finalOP7)
            out.write(finalOP7)
            frameNumber += 1
